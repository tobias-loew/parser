...
auto auto_assign_string_1 = [](std::string const & str) { return str; };
auto auto_assign_string_2 = [](std::string && str) { return std::move(str); };
...
constexpr rule<struct str_rule_4_tag, std::string> str_rule_4 = "str_rule_4";
constexpr auto str_rule_4_def = (+char_)[auto_assign_string_1];
BOOST_PARSER_DEFINE_RULES(str_rule_4);

constexpr rule<struct str_rule_5_tag, std::string> str_rule_5 = "str_rule_5";
constexpr auto str_rule_5_def = (+char_)[auto_assign_string_2];
BOOST_PARSER_DEFINE_RULES(str_rule_5);
...
{
    {
        ...
        auto result_4 = parse("some text", str_rule_4);
        EXPECT_TRUE(result_4);
        EXPECT_EQ(*result_4, "some text");

        auto result_5 = parse("some text", str_rule_5);
        EXPECT_TRUE(result_5);
        EXPECT_EQ(*result_5, "some text");
